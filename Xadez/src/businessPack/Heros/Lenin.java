...
public class Lenin extends Hero {
    ...
    public void createArmy(Army army, int sentido){
        ...
        army.addPiece(new Bishop(new LeninBishop(), TypeHero.lenin, 2, (int)(3.5 + sentido*2.5), LeninBishopImage));// Bispos 
        army.addPiece(new Bishop(new LeninBishop(), TypeHero.lenin, 5, (int)(3.5 + sentido*2.5), LeninBishopImage));// Bispos 
