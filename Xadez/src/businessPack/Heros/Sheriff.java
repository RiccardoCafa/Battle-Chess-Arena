...
public class Sheriff extends Hero {
    ...
    public void createArmy(Army army, int sentido, Player player){
        ...
        army.addPiece(new  Horse(player, TypeHero.sheriff, 1, (int)(3.5 + sentido*3.5), new SheriffHorse()));//cavalos
        army.addPiece(new  Horse(player, TypeHero.sheriff, 6, (int)(3.5 + sentido*3.5), new SheriffHorse()));
