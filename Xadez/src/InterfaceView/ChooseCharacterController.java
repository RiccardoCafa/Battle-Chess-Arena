...
public class ChooseCharacterController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        perso[0] = new Image("InterfaceView/huehuebr-01.png");
        perso[1] = new Image("InterfaceView/lapa-01.png");
        perso[2] = new Image("InterfaceView/lenin-01.png");
        perso[3] = new Image("InterfaceView/omago-01.png");
        perso[4] = new Image("InterfaceView/pistoleiro-01.png");
